...
parser.add_argument('--threshold', type=float, default=0.5, help='do you want to perform the test suite?')
parser.add_argument('--name', type=str, default='default', help='ID of output GENRE')
